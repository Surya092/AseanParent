...
class BaseRequestModel: NSObject {
    public lazy var networkManager = NetworkManager()
}
...
class NetworkManager: NSObject {
    ...
    public func postData(withParameters requestData:[String: Any], headers:[String: String]? = nil, cachePolicy : URLRequest.CachePolicy = .useProtocolCachePolicy, apiEndpoint apiURL: String, isurlEncoded urlencoded: Bool = false, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Swift.Void) {
        self.makeServerRequest(requestType: RequestType.Post.rawValue, cachePolicy : cachePolicy, withData: requestData,  apiEndpoint: apiURL, parameters: headers, urlencoded: urlencoded, CompletionHandler: completionHandler)
    }
    ...
    public func putData(withParameters requestData:[String: Any], cachePolicy : URLRequest.CachePolicy = .useProtocolCachePolicy, apiEndpoint apiURL: String, isurlEncoded urlencoded: Bool = false, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Swift.Void) {
        self.makeServerRequest(requestType: RequestType.Put.rawValue, cachePolicy : cachePolicy, withData: requestData, apiEndpoint: apiURL, urlencoded: urlencoded, CompletionHandler: completionHandler)
    }
    ...
    public func getData(withApiEndpoint apiURL: String, cachePolicy : URLRequest.CachePolicy = .useProtocolCachePolicy, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Swift.Void) {
        self.makeServerRequest(requestType: RequestType.Get.rawValue, cachePolicy : cachePolicy, apiEndpoint: apiURL, CompletionHandler: completionHandler)
    }
    
    //Use this for Deleter request
    public func deleteData(withApiEndpoint apiURL: String, cachePolicy : URLRequest.CachePolicy = .useProtocolCachePolicy, completionHandler: @escaping (Data?, URLResponse?, Error?) -> Swift.Void) {
        self.makeServerRequest(requestType: RequestType.Delete.rawValue, cachePolicy : cachePolicy, apiEndpoint: apiURL, CompletionHandler: completionHandler)
    }
